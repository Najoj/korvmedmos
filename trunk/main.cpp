/**
 * Main cpp file. This is where all the good stuff happens.
 */
...
int main(int argc, char ** argv)
{
	...
	// Make the root node, this will be pushed onto pqueue and marked as visited.
	...
	// Reverse the string into correct order.
	string::iterator pos;
	string rev_solution;
